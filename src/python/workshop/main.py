...
mcp_server_url = os.environ.get("MCP_SERVER_URL", "https://1rhz2hth-8010.aue.devtunnels.ms/mcp")
mcp_server_label = os.environ.get("MCP_SERVER_LABEL", "ZavaMcpServer")
...
mcp_tool = McpTool(
    ...
    allowed_tools=["get_multiple_table_schemas"],  # Optional: specify allowed tools
)

# You can also add or remove allowed tools dynamically
# search_api_code = "get_multiple_table_schemas"
...
with project_client:
    ...
    message = agents_client.messages.create(
        thread_id=thread.id,
        role="user",
        content="Show the exact schema for the retail.customers table.",
    )
